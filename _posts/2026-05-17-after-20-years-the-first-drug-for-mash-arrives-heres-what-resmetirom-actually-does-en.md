...
![MASLD to cirrhosis: disease progression](https://raw.githubusercontent.com/jeonghun-project/health-en/main/assets/images/2026-05-17-after-20-years-the-first-drug-for-mash-arrives-heres-what-resmetirom-actually-does-en-flow-mash-progression-en.png)
...
![MAESTRO-NASH key numbers](https://raw.githubusercontent.com/jeonghun-project/health-en/main/assets/images/2026-05-17-after-20-years-the-first-drug-for-mash-arrives-heres-what-resmetirom-actually-does-en-stats-maestro-nash-en.png)
...
1. **Receptor selectivity**: The thyroid hormone receptor has two isoforms. THR-β predominates in the liver; THR-α predominates in the heart and skeletal muscle. Conventional thyroid hormone (T3, levothyroxine) activates both, which is why "thyroid hormone for weight loss" causes tachycardia, muscle wasting, and bone loss — these are THR-α effects.
2. **Resmetirom's design**: Resmetirom (development code MGL-3196) binds THR-β with approximately 28-fold selectivity over THR-α. It also concentrates in the liver via organic anion transporting polypeptide (OATP) uptake.
3. **Downstream transcription**: Activated hepatic THR-β upregulates genes encoding mitochondrial fatty acid β-oxidation enzymes (CPT1, ACAD family) and the LDL receptor.
4. **Lipid handling**: Increased β-oxidation burns hepatic triglyceride stores. LDL receptor upregulation lowers serum LDL-C — a useful secondary effect in MASH patients, who carry high cardiovascular risk.
5. **Histologic outcome**: Reduced lipotoxicity quiets hepatocyte injury, ballooning, and inflammation — the histologic features that define MASH.
...
![Western vs lean (Asian) MASH](https://raw.githubusercontent.com/jeonghun-project/health-en/main/assets/images/2026-05-17-after-20-years-the-first-drug-for-mash-arrives-heres-what-resmetirom-actually-does-en-comparison-mash-west-en.png)
